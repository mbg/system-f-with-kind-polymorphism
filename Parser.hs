...
action_21 (13) = happyShift action_25
...
happyReduction_4 (HappyTerminal (TVal happy_var_1))
	 =  HappyAbsSyn7
		 (Val happy_var_1
	)
...
happyReduction_8 (HappyTerminal (TType happy_var_1))
	 =  HappyAbsSyn8
		 (ConTy happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TClose -> cont 15;
	TArrow -> cont 16;
	TDef happy_dollar_dollar -> cont 17;
	TVal happy_dollar_dollar -> cont 18;
	TVar happy_dollar_dollar -> cont 19;
	TType happy_dollar_dollar -> cont 20;
	_ -> happyError' (tk:tks)
	}
