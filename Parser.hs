...
action_23 (14) = happyShift action_23
...
happyReduction_9 (HappyTerminal (TType happy_var_1))
	 =  HappyAbsSyn8
		 (ConTy happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TClose -> cont 15;
	TArrow -> cont 16;
	TVal happy_dollar_dollar -> cont 17;
	TVar happy_dollar_dollar -> cont 18;
	TType happy_dollar_dollar -> cont 19;
	_ -> happyError' (tk:tks)
	}
